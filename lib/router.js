...
Router.route('/command', {
  name: 'command',
  waitOn: function() {
    return [ Meteor.subscribe('workers'), Meteor.subscribe('soldiers'), Meteor.subscribe('resources') ];
  }
});
...
Router.route('/armory', {
  ...
  waitOn: function() {
    return [ Meteor.subscribe('workers'), Meteor.subscribe("soldiers"),
      Meteor.subscribe('offWeapons'), Meteor.subscribe('defWeapons'), Meteor.subscribe('resources') ];
  }
});
