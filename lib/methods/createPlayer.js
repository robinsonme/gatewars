Meteor.methods({
  ...
  'createResourceDB': function(player) {
    ...
    var resourceData = {
      createdBy: currentPlayer._id,
      resources: [
        {name: "Credits", amount: STARTING_CREDITS, consumptionRate: 0, productionRate: 0},
        {name: "Ore", amount: STARTING_MINERALS, consumptionRate: 0, productionRate: 0},
      ]
    };
  ...
  'createOffensiveDB': function(player) {
    ...
    var offensiveData = {
      createdBy: currentPlayer._id,
      offWeapons: [
        {name: "9mm", cost: STARTING_9MM_COST, number: 0, power: 1, type: "Ore"},
        {name: "MP-5", cost: STARTING_MP5_COST, number: 0, power: 5, type: "Ore"},
        {name: ".50 Caliber Rifle", cost: STARTING_50_CALIBER_COST, number: 0, power: 25, type: "Ore"},
        {name: "Laser Cannon", cost: STARTING_LASER_CANNON_COST, number: 0, power: 100, type: "Ore"},
        {name: "Plasma Cannon", cost: STARTING_PLASMA_CANNON_COST, number: 0, power: 500, type: "Ore"},
      ]
    };
  ...
  'createDefensiveDB': function(player) {
    ...
    var defensiveData = {
      createdBy: currentPlayer._id,
      defWeapons: [
        {name: "Riot Shield", cost: STARTING_RIOT_SHIELD_COST, number: 0, power: 1, type: "Ore"},
        {name: "Body Armor", cost: STARTING_BODY_ARMOR_COST, number: 0, power: 5, type: "Ore"},
        {name: "Mechanoid Suit", cost: STARTING_MECHANOID_SUIT_COST, number: 0, power: 25, type: "Ore"},
        {name: "Personal Force Field", cost: STARTING_PERSONAL_FORCE_FIELD_COST, number: 0, power: 100, type: "Ore"},
        {name: "Holographic Projection System", cost: STARTING_HOLOGRAPHIC_PROJECTION_SYSTEM_COST, number: 0, power: 500, type: "Ore"},
      ]
    };
